package com.example.demo.fileuploadboard.common;
...
public class FileUtils {
    ...
    public List<BoardFile> parseFileInfo(Board board, MultipartHttpServletRequest multipartHttpServletRequest) throws Exception {
